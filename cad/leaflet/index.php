 ...
 * パンくず設定
 ********************************************************************/
$pan[0]["title"] = "―イメージを忠実にカタチに― 小島衣料 CADサービス資料";
//---------------------------------------------------------//
//エラーチェック
//---------------------------------------------------------//
...
if ($_POST['act'] == "fin") {
  ...
  $url = 'https://marketing.tmedia.jp/sys/management_tm_kojima/form/leaflet.php';
...
<head>
  ...
  <meta name="keywords" content="―イメージを忠実にカタチに― 小島衣料 CADサービス資料">
  <meta name="description" content="各種サービスの単価、納品目安から発注のステップまでが一覧でわかる資料がダウンロードできます。">
  <meta name="author" content="">
  <title>―イメージを忠実にカタチに― 小島衣料 CADサービス資料 | 小島衣料CADサービス | </title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<meta name="theme-color" content="#110058"> -->
  ...
  <meta name="twitter:title" content="―イメージを忠実にカタチに― 小島衣料 CADサービス資料 | 小島衣料CADサービス | サイトタイトル">
  <meta name="twitter:image:src" content="">

  <!-- Open Graph data -->
  <meta property="og:title" content="―イメージを忠実にカタチに― 小島衣料 CADサービス資料 | 小島衣料CADサービス | サイトタイトル">
...
<body class="home page" id="price">
      ...
      <div class="container pt20_sp mt60_pc flex_box fw_wrap">
        <div class="priceboxs_l">
          <div class="heading-primary">
            <h1 class="heading-primary__ttl">―イメージを忠実にカタチに―<br>小島衣料 CADサービス資料</h2>
          </div>
          <div class="wpimg_box">
            <img src="<?php echo $url_path; ?>/assets/img/leaflet/price_wp.jpg" style="border:1px solid #ccc;">
          </div>
          <div class="txt_box">
            <p class="ttl">各種サービスの単価、納品目安から発注のステップまでが一覧でわかる資料がダウンロードできます。</p>
            <p class="blackbox">目次</p>
            <div class="ul_box">
              <ul>
                <li>小島衣料のサービス内容・料金</li>
                <li>相談～発注までの3ステップ</li>
                <li>お客様の声</li>
                <li>よくあるご質問</li>
              </ul>
        ...
        <div class="priceboxs_r">
          <div class="price_form_box">
            <p class="tac mb40">資料ダウンロードご希望の方は、下記フォームに必要事項をご記入の上、送信ボタンを押してください。</p>
            ...
            <form action="" method="post" name="form1">
              ...
              <p class="agree_dec">
              資料ダウンロードは「<a href="http://www.kojima-iryo.com/privacy.html" target="_blank" style="display: inline;">個人情報の取扱いについて</a>」への同意が必要です。内容をご確認の上、ご同意いただける場合「同意する」にチェックをして、「上記に同意して確認画面へ進む」をクリックしてください。
              </p>
  ...
  if ($_POST['act'] == "conf") {
    ...
    ?>
      <div class="container">
        <div class="heading-primary">
          <h2 class="heading-primary__ttl">CADサービス資料<br class="sp-only">ダウンロードフォーム</h2>
