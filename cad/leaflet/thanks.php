...
<meta name="theme-color" content="#110058"> -->
  ...
  <meta name="twitter:title" content="CADサービス資料ダウンロード| 小島衣料CADサービス | サイトタイトル">
  <meta name="twitter:image:src" content="">

  <!-- Open Graph data -->
  <meta property="og:title" content="CADサービス資料ダウンロード| 小島衣料CADサービス | サイトタイトル">
...
<body class="home page blog">
  ...
  <div class="container mb40">
    <div class="heading-primary">
      <h2 class="heading-primary__ttl">CADサービス資料ダウンロード</h2>
      <p class="heading-primary__ttl__dec tac"><span class="fwb">ありがとうございました。</span><br>
        登録いただきましたメールアドレス宛にCADサービス資料の資料URLをお送り致しました。<br>
