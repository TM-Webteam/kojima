            ...
            <div class="archive_box">
              ...
              <div class="flex_box wrap">
                <div class="archive_img">
                  <a href="<?php echo $url_path; ?>/blog/detail/<?php echo $value['slug'] ?>"><img src="<?php echo $url_path; ?>/up_file/<?php echo $value['up_file1'] ?>"></a>
                </div>
                <div class="archive_dec">
                  <?php
                  if (!empty($value['comment'])) {
                  ?>
                    <p class="title_un_comment"><?php echo $value['comment']; ?></p>
                  <?php
                  } else {
                  ?>
