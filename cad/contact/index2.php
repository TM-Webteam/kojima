...
if ($_POST['act'] == 'conf' or $_POST['act'] == 'fin') {
  ...
  $err_mess[] = SelectChk($_POST['reference_item'], "いずれかお持ちの方はお選びください");
...
if ($_POST['act'] == "fin") {
  ...
  $url = 'https://www.marke-media.net/sys/management_tm_kojima/form/contact.php';
  $url = 'http://marketing.tmedia.jp/sys/management_tm_kojima/form/contact.php';
  ...
  // $result = curl_exec($ch);
  // curl_close($ch);
  // $primarykey_11 = json_decode($result, true);

  // var_dump($primarykey_11);
  ...
  ?>
    ...
    <div class="container">
      <div class="heading-primary">
        ...
        <p class="heading-primary__ttl__dec">以下に必要事項をご記入の上、確認画面ボタンをクリックしてください。<br>後ほど担当者より折り返しご連絡をさせて頂きます。<br><br>
    ...
    <form action="" method="post" name="form1">
      <div class="contact_form">
        <table>
          ...
          <tr>
            <th>検討されているサービス<span>必須</span></th>
            <td>
          ...
          <tr>
            <th>ご相談・お問合せの区分<span>必須</span></th>
            <td>
          ...
          <tr>
            <th>いずれかお持ちの方はお選びください<span>必須</span></th>
            <td>
  ...
  ?>
    ...
    <div class="contact_form">
      <table>
        ...
        <tr>
          <th>検討されているサービス<span>※</span></th>
          <td><?php echo $interested_service ?></td>
        </tr>
        <tr>
          <th>ご相談・お問合せの区分<span>※</span></th>
          <td><?php echo $contact_type ?></td>
        </tr>

        <tr>
          <th>いずれかお持ちの方はお選びください</th>
